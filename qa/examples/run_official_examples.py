#!/usr/bin/env python3
"""Run every script embedded in mumax.github.io/examples.html."""
...
def fetch_source(url: str) -> bytes:
    request = urllib.request.Request(
        url, headers={"User-Agent": "mumax3-for-mac-official-examples-QA/1"}
    )
...
if __name__ == "__main__":
    try:
        ...
        print(f"QA harness error: {error}", file=sys.stderr)
        sys.exit(2)
